...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(div, "class", "m-72 p-4 px-5 shadow-sm project rounded-lg  svelte-1qqqk2x");
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-1qqqk2x");
...
//# sourceMappingURL=other-tabs-fe2400aa.js.map
