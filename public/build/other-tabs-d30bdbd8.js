...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h2, file$1, 7, 2, 140);
			attr_dev(div, "class", "flex flex- tabs w-full");
...
//# sourceMappingURL=other-tabs-d30bdbd8.js.map
