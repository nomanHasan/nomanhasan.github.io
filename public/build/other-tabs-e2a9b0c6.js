...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 25, 6, 554);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 26, 6, 623);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 27, 6, 695);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 29, 8, 830);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 28, 6, 755);
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-1wmngps");
			add_location(div, file$1, 24, 4, 492);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-1wmngps");
			add_location(div, file$1, 22, 0, 372);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-e2a9b0c6.js.map
