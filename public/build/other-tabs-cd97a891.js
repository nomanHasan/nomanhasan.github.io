...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h2, file$1, 7, 2, 133);
			attr_dev(div, "class", "flex flex- tabs");
...
//# sourceMappingURL=other-tabs-cd97a891.js.map
