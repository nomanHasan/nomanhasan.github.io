...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-5woc5v");
			add_location(div, file$2, 36, 0, 806);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-3ec36b5e.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-4657c948.js.map
