...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 58, 10, 1784);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 71, 10, 2273);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div12, file$2, 55, 6, 1649);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 56, 6, 1689);
			attr_dev(div14, "class", "py-4");
			add_location(div14, file$2, 54, 4, 1624);
			attr_dev(div15, "class", " py-2");
			add_location(div15, file$2, 68, 6, 2131);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 69, 6, 2175);
			attr_dev(div17, "class", "py-4");
			add_location(div17, file$2, 67, 4, 2106);
...
//# sourceMappingURL=other-tabs-c80233fb.js.map
