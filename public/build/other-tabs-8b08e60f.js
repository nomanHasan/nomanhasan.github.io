...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 25, 6, 569);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 26, 6, 638);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 27, 6, 710);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 29, 8, 845);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 28, 6, 770);
			attr_dev(div, "class", "m-72 p-4 px-5 shadow-sm project rounded-lg  svelte-8431rv");
			add_location(div, file$1, 24, 4, 505);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-8431rv");
			add_location(div, file$1, 22, 0, 385);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-8b08e60f.js.map
