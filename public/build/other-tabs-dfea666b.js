...
// (18:6) {#each skills.proficient.language as language}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 18, 8, 406);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(18:6) {#each skills.proficient.language as language}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	let div1;
	let t3;
	let each_value = skills.proficient.language;
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*skills*/ 0) {
				each_value = skills.proficient.language;
				validate_each_argument(each_value);
				let i;
...
//# sourceMappingURL=other-tabs-dfea666b.js.map
