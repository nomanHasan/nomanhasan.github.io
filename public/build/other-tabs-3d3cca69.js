...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 54, 10, 1431);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div15, file$2, 51, 6, 1288);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 52, 6, 1334);
			add_location(div17, file$2, 50, 4, 1276);
...
//# sourceMappingURL=other-tabs-3d3cca69.js.map
