...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 31, 10, 909);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 43, 10, 1306);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 58, 10, 1770);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 71, 10, 2259);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file$2, 16, 6, 369);
			attr_dev(div2, "class", "flex flex-row");
			add_location(div2, file$2, 17, 6, 409);
			attr_dev(div3, "class", "py-4");
			add_location(div3, file$2, 15, 4, 344);
			attr_dev(div4, "class", "py-2");
			add_location(div4, file$2, 28, 6, 766);
			attr_dev(div5, "class", "flex flex-row");
			add_location(div5, file$2, 29, 6, 809);
			attr_dev(div6, "class", "py-4");
			add_location(div6, file$2, 27, 4, 741);
			attr_dev(div7, "class", " py-2");
			add_location(div7, file$2, 40, 6, 1168);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 41, 6, 1209);
			attr_dev(div9, "class", "py-4");
			add_location(div9, file$2, 39, 4, 1143);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 269);
			attr_dev(div11, "class", "text-3xl");
			add_location(div11, file$2, 53, 4, 1569);
			attr_dev(div12, "class", " py-2");
			add_location(div12, file$2, 55, 6, 1635);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 56, 6, 1675);
			attr_dev(div14, "class", "py-4");
			add_location(div14, file$2, 54, 4, 1610);
			attr_dev(div15, "class", " py-2");
			add_location(div15, file$2, 68, 6, 2117);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 69, 6, 2161);
			attr_dev(div17, "class", "py-4");
			add_location(div17, file$2, 67, 4, 2092);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 52, 2, 1547);
...
//# sourceMappingURL=other-tabs-867f8465.js.map
