...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light");
			add_location(div, file$1, 31, 12, 1024);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-semibold");
			add_location(div, file$1, 29, 12, 949);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
// (28:8) {#each proj.development_tools as devt, i}
function create_each_block_1$1(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*i*/ ctx[5] == 0) return create_if_block_1$1;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(28:8) {#each proj.development_tools as devt, i}",
		ctx
	});
...
// (36:6) {#if proj.description}
function create_if_block$1(ctx) {
	let div;
	let t_value = /*proj*/ ctx[0].description + "";
	let t;
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light text-gray-700 mt-2");
			add_location(div, file$1, 36, 8, 1155);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(36:6) {#if proj.description}",
		ctx
	});
...
// (19:2) {#each projects as proj (proj.name)}
function create_each_block$1(key_1, ctx) {
	let div1;
	let h2;
	let t0_value = /*proj*/ ctx[0].name + "";
	let t0;
	let t1;
	let h30;
	let t2_value = /*proj*/ ctx[0].location + "";
	let t2;
	let t3;
	let h31;
	let t4_value = /*proj*/ ctx[0].position + "";
	let t4;
	let t5;
	let h32;
	let t6_value = /*proj*/ ctx[0].from + "";
	let t6;
	let t7;
	let t8_value = /*proj*/ ctx[0].to + "";
	let t8;
	let t9;
	let div0;
	let t10;
	let t11;
	let each_value_1 = /*proj*/ ctx[0].development_tools;
	validate_each_argument(each_value_1);
	let each_blocks = [];
	...
	let if_block = /*proj*/ ctx[0].description && create_if_block$1(ctx);
	...
	const block = {
		...
		c: function create() {
			...
			t11 = space();
			attr_dev(h2, "class", "text-gray-700 font-semibold");
			add_location(h2, file$1, 20, 6, 476);
			attr_dev(h30, "class", "text-cyan-400 font-hairline");
			add_location(h30, file$1, 21, 6, 539);
			attr_dev(h31, "class", "text-gray-700 ");
			add_location(h31, file$1, 22, 6, 606);
			attr_dev(h32, "class", "text-gray-500 font-light");
			add_location(h32, file$1, 23, 6, 660);
			attr_dev(div0, "class", "flex flex-row overflow-hidden");
			set_style(div0, "max-width", "100%");
			set_style(div0, "text-overflow", "ellipsis");
			set_style(div0, "white-space", "nowrap");
			...
			attr_dev(div1, "class", "p-4 px-5 shadow-sm m-1 rounded-lg");
			add_location(div1, file$1, 19, 4, 422);
			this.first = div1;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*projects*/ 0) {
				each_value_1 = /*proj*/ ctx[0].development_tools;
				validate_each_argument(each_value_1);
				let i;
			...
			if (/*proj*/ ctx[0].description) if_block.p(ctx, dirty);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(div1);
			destroy_each(each_blocks, detaching);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(19:2) {#each projects as proj (proj.name)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	validate_each_argument(each_value);
	const get_key = ctx => /*proj*/ ctx[0].name;
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 experience w-full svelte-oz47om");
			add_location(div, file$1, 17, 0, 301);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment$2(ctx) {
	...
	experience2 = new Experience_card({ $$inline: true });
...
//# sourceMappingURL=other-tabs-c7fe04d5.js.map
