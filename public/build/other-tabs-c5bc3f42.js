...
function create_each_block_4(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			attr_dev(div, "class", "m-1 p-2 bg-gray-100");
...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 27, 10, 739);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 35, 10, 954);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 46, 10, 1238);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 54, 10, 1459);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file$2, 24, 6, 596);
			attr_dev(div5, "class", "flex flex-row");
			add_location(div5, file$2, 25, 6, 642);
			add_location(div6, file$2, 23, 4, 584);
			attr_dev(div7, "class", "text-xl");
			add_location(div7, file$2, 32, 6, 817);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 33, 6, 860);
			add_location(div9, file$2, 31, 4, 805);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 277);
			attr_dev(div11, "class", "text-2xl");
			add_location(div11, file$2, 41, 4, 1049);
			attr_dev(div12, "class", "text-xl");
			add_location(div12, file$2, 43, 6, 1102);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 44, 6, 1144);
			add_location(div14, file$2, 42, 4, 1090);
			attr_dev(div15, "class", "text-xl");
			add_location(div15, file$2, 51, 6, 1316);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 52, 6, 1362);
			add_location(div17, file$2, 50, 4, 1304);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 40, 2, 1027);
...
//# sourceMappingURL=other-tabs-c5bc3f42.js.map
