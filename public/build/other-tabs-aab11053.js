...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light");
			add_location(div, file$1, 31, 12, 1026);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-semibold");
			add_location(div, file$1, 29, 12, 951);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light text-gray-700 mt-2");
			add_location(div, file$1, 36, 8, 1157);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(h30, "class", "text-cyan-400 font-hairline");
			add_location(h30, file$1, 21, 6, 541);
			attr_dev(h31, "class", "text-gray-700 ");
			add_location(h31, file$1, 22, 6, 608);
			attr_dev(h32, "class", "text-gray-500 font-light");
			add_location(h32, file$1, 23, 6, 662);
			attr_dev(div0, "class", "flex flex-row overflow-hidden");
			set_style(div0, "max-width", "100%");
			set_style(div0, "text-overflow", "ellipsis");
			set_style(div0, "white-space", "nowrap");
			add_location(div0, file$1, 24, 6, 734);
			attr_dev(div1, "class", "p-4 px-5 shadow-sm m-1 rounded-lg");
...
//# sourceMappingURL=other-tabs-aab11053.js.map
