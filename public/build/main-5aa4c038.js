...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 28, 4, 496);
			attr_dev(h1, "class", "text-4xl text-gray-800 name uppercase text-center my-4 svelte-14li7x4");
			add_location(h1, file$1, 34, 4, 627);
			attr_dev(h20, "class", "text-lg text-gray-700 text-center n2 svelte-14li7x4");
			add_location(h20, file$1, 37, 4, 727);
			attr_dev(h21, "class", "text-md text-gray-600 text-center n2 svelte-14li7x4");
			add_location(h21, file$1, 38, 4, 803);
			add_location(b0, file$1, 40, 6, 928);
			attr_dev(h22, "class", "text-md text-gray-700 text-center n2 svelte-14li7x4");
			add_location(h22, file$1, 39, 4, 872);
			attr_dev(div0, "class", "flex flex-col py-4");
			add_location(div0, file$1, 43, 4, 989);
			add_location(b1, file$1, 55, 8, 1429);
			attr_dev(a0, "class", "text-gray-800 text-center");
			attr_dev(a0, "href", "mailto:nomanbinhussein@gmail.com");
			add_location(a0, file$1, 52, 6, 1327);
			attr_dev(div1, "class", "flex flex-col mb-4");
			add_location(div1, file$1, 51, 4, 1288);
			add_location(b2, file$1, 60, 8, 1605);
			attr_dev(a1, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a1, "href", "#projects");
			add_location(a1, file$1, 59, 6, 1527);
			add_location(b3, file$1, 63, 8, 1718);
			attr_dev(a2, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a2, "href", "#experience");
			add_location(a2, file$1, 62, 6, 1638);
			add_location(b4, file$1, 66, 8, 1829);
			attr_dev(a3, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a3, "href", "#skills");
			add_location(a3, file$1, 65, 6, 1753);
			attr_dev(div2, "class", "flex flex-col mb-4");
			add_location(div2, file$1, 58, 4, 1488);
			attr_dev(div3, "class", "innerdiv flex flex-col justify-start");
			add_location(div3, file$1, 27, 2, 441);
			attr_dev(div4, "class", "profile flex flex-row justify-center svelte-14li7x4");
			add_location(div4, file$1, 26, 0, 388);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-1ajcg04");
			add_location(div, file$2, 36, 0, 863);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-5c240918.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-5aa4c038.js.map
