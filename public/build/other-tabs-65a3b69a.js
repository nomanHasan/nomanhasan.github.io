...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 43, 10, 1268);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 58, 10, 1706);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 71, 10, 2169);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div7, file$2, 40, 6, 1128);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 41, 6, 1171);
			...
			add_location(div11, file$2, 53, 4, 1516);
			attr_dev(div12, "class", "text-xl");
			add_location(div12, file$2, 55, 6, 1569);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 56, 6, 1611);
			add_location(div14, file$2, 54, 4, 1557);
			attr_dev(div15, "class", "text-xl");
			add_location(div15, file$2, 68, 6, 2025);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 69, 6, 2071);
			add_location(div17, file$2, 67, 4, 2013);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 52, 2, 1494);
...
//# sourceMappingURL=other-tabs-65a3b69a.js.map
