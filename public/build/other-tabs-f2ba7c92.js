...
function create_fragment$2(ctx) {
	...
	let div1;
	let t3;
	let each_value = skills.proficient.languages;
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		c: function create() {
			...
			add_location(div3, file$2, 13, 2, 277);
			attr_dev(div4, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 skills w-full svelte-1oqoaym");
			add_location(div4, file$2, 12, 0, 201);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*skills*/ 0) {
				each_value = skills.proficient.languages;
				validate_each_argument(each_value);
				let i;
...
//# sourceMappingURL=other-tabs-f2ba7c92.js.map
