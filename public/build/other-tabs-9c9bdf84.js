...
// (19:8) {#each skills.proficient.languages as language}
function create_each_block_4(ctx) {
	let div;
	let t_value = /*language*/ ctx[0] + "";
	let t;
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			attr_dev(div, "class", "m-1 p-2 rounded-md bg-gray-100");
			add_location(div, file$2, 19, 10, 490);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(19:8) {#each skills.proficient.languages as language}",
		ctx
	});
...
// (27:8) {#each skills.proficient.technologies as language}
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 27, 10, 750);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(27:8) {#each skills.proficient.technologies as language}",
		ctx
	});
...
// (35:8) {#each skills.proficient.databases as language}
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 35, 10, 965);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(35:8) {#each skills.proficient.databases as language}",
		ctx
	});
...
// (46:8) {#each skills.proficient.languages as language}
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 46, 10, 1249);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(46:8) {#each skills.proficient.languages as language}",
		ctx
	});
...
// (54:8) {#each skills.proficient.technologies as language}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 54, 10, 1470);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(54:8) {#each skills.proficient.technologies as language}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	let each_value_1 = skills.proficient.languages;
	validate_each_argument(each_value_1);
	let each_blocks_1 = [];
	...
	let each_value = skills.proficient.technologies;
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "text-2xl");
			add_location(div0, file$2, 14, 4, 299);
			attr_dev(div1, "class", "text-xl");
			add_location(div1, file$2, 16, 6, 354);
			attr_dev(div2, "class", "flex flex-row");
			add_location(div2, file$2, 17, 6, 396);
			add_location(div3, file$2, 15, 4, 342);
			attr_dev(div4, "class", "text-xl");
			add_location(div4, file$2, 24, 6, 607);
			attr_dev(div5, "class", "flex flex-row");
			add_location(div5, file$2, 25, 6, 653);
			add_location(div6, file$2, 23, 4, 595);
			attr_dev(div7, "class", "text-xl");
			add_location(div7, file$2, 32, 6, 828);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 33, 6, 871);
			add_location(div9, file$2, 31, 4, 816);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 277);
			attr_dev(div11, "class", "text-2xl");
			add_location(div11, file$2, 41, 4, 1060);
			attr_dev(div12, "class", "text-xl");
			add_location(div12, file$2, 43, 6, 1113);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 44, 6, 1155);
			add_location(div14, file$2, 42, 4, 1101);
			attr_dev(div15, "class", "text-xl");
			add_location(div15, file$2, 51, 6, 1327);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 52, 6, 1373);
			add_location(div17, file$2, 50, 4, 1315);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 40, 2, 1038);
			attr_dev(div19, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 skills w-full svelte-1oqoaym");
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*skills*/ 0) {
				each_value_1 = skills.proficient.languages;
				validate_each_argument(each_value_1);
				let i;
			...
			if (dirty & /*skills*/ 0) {
				each_value = skills.proficient.technologies;
				validate_each_argument(each_value);
				let i;
...
function create_fragment$3(ctx) {
	...
	let skills1;
	let current;
	skills0 = new Skills({ $$inline: true });
	experience = new Experience_card({ $$inline: true });
	skills1 = new Skills({ $$inline: true });
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(skills0.$$.fragment);
			t2 = space();
			h21 = element("h2");
			...
			t7 = space();
			create_component(skills1.$$.fragment);
		...
		m: function mount(target, anchor) {
			...
			append_dev(div, h20);
			append_dev(div, t1);
			mount_component(skills0, div, null);
			append_dev(div, t2);
			append_dev(div, h21);
			append_dev(div, t4);
			...
			append_dev(div, h22);
			append_dev(div, t7);
			mount_component(skills1, div, null);
			current = true;
		},
		p: noop,
		i: function intro(local) {
			if (current) return;
			transition_in(skills0.$$.fragment, local);
			transition_in(experience.$$.fragment, local);
			transition_in(skills1.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(skills0.$$.fragment, local);
			transition_out(experience.$$.fragment, local);
			transition_out(skills1.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(div);
			destroy_component(skills0);
			destroy_component(experience);
			destroy_component(skills1);
		}
	};
...
//# sourceMappingURL=other-tabs-9c9bdf84.js.map
