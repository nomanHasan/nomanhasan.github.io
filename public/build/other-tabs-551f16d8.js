...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 31, 10, 899);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 43, 10, 1288);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 58, 10, 1744);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 71, 10, 2225);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div5, file$2, 29, 6, 799);
			attr_dev(div6, "class", "py-4");
			add_location(div6, file$2, 27, 4, 731);
			attr_dev(div7, "class", "text-xl py-2");
			add_location(div7, file$2, 40, 6, 1143);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 41, 6, 1191);
			attr_dev(div9, "class", "py-4");
			add_location(div9, file$2, 39, 4, 1118);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 277);
			attr_dev(div11, "class", "text-3xl");
			add_location(div11, file$2, 53, 4, 1536);
			attr_dev(div12, "class", "text-xl py-2");
			add_location(div12, file$2, 55, 6, 1602);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 56, 6, 1649);
			attr_dev(div14, "class", "py-4");
			add_location(div14, file$2, 54, 4, 1577);
			attr_dev(div15, "class", "text-xl py-2");
			add_location(div15, file$2, 68, 6, 2076);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 69, 6, 2127);
			attr_dev(div17, "class", "py-4");
			add_location(div17, file$2, 67, 4, 2051);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 52, 2, 1514);
...
//# sourceMappingURL=other-tabs-551f16d8.js.map
