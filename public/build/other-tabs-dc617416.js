...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-l9zbuq");
...
//# sourceMappingURL=other-tabs-dc617416.js.map
