...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 58, 10, 1680);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
// (70:8) {#each skills.familiar.technologies as language, i}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 70, 10, 2055);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(70:8) {#each skills.familiar.technologies as language, i}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div15, file$2, 67, 6, 1911);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 68, 6, 1957);
			add_location(div17, file$2, 66, 4, 1899);
...
//# sourceMappingURL=other-tabs-89b1f600.js.map
