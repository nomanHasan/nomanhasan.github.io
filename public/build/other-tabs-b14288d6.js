...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-wsn3k0");
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-wsn3k0");
...
//# sourceMappingURL=other-tabs-b14288d6.js.map
