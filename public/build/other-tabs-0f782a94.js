...
// (16:6) {#each skills.proficient.languages as language}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 16, 8, 383);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(16:6) {#each skills.proficient.languages as language}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$2, 12, 4, 263);
			add_location(div1, file$2, 14, 6, 301);
			add_location(div2, file$2, 13, 4, 289);
			add_location(div3, file$2, 11, 2, 253);
			attr_dev(div4, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 skills w-full svelte-1oqoaym");
			add_location(div4, file$2, 10, 0, 177);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-0f782a94.js.map
