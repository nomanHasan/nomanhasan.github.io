...
function create_if_block(ctx) {
	...
	let current;
	var switch_value = /*Experience*/ ctx[0];
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (switch_value !== (switch_value = /*Experience*/ ctx[0])) {
				if (switch_instance) {
					group_outros();
...
function create_fragment$2(ctx) {
	...
	let if_block = /*Experience*/ ctx[0] && create_if_block(ctx);
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start svelte-jt5soe");
			add_location(div, file$2, 24, 0, 577);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./experience-card-8f5441e1.js').then(module => module.default).then(component => {
		$$invalidate(0, Experience = component);
	...
	$$self.$capture_state = () => ({ Profile: Profile_card, Experience });
...
export { Button as B, SvelteComponentDev as S, validate_each_keys as a, validate_slots as b, space as c, dispatch_dev as d, element as e, attr_dev as f, add_location as g, set_style as h, init as i, insert_dev as j, append_dev as k, detach_dev as l, destroy_each as m, noop as n, empty as o, destroy_block as p, app as q, safe_not_equal as s, text as t, update_keyed_each as u, validate_each_argument as v };
//# sourceMappingURL=main-1c43ae62.js.map
