...
/* src/tailwind.svelte generated by Svelte v3.23.2 */
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 38, 0, 831);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-bc1b5c8a.js').then(module => module.default).then(component => {
	...
	$$self.$capture_state = () => ({ Profile: Profile_card, Tailwind, OtherTabs });
...
//# sourceMappingURL=main-39abc45b.js.map
