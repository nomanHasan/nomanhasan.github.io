...
// (18:2) {#each projects as proj (proj.title)}
function create_each_block$1(key_1, ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(18:2) {#each projects as proj (proj.title)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 projects w-full svelte-1ko65u2");
			add_location(div, file$1, 16, 0, 279);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-db6b7cbd.js.map
