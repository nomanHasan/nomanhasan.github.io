...
// (25:2) {#each projects as proj (proj.title)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 26, 6, 582);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 27, 6, 651);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 28, 6, 723);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 30, 8, 858);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 29, 6, 783);
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-12wgpzm");
			add_location(div, file$1, 25, 4, 520);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(25:2) {#each projects as proj (proj.title)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-12wgpzm");
...
//# sourceMappingURL=other-tabs-0baaf82a.js.map
