...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 24, 6, 548);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 25, 6, 617);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 26, 6, 689);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 28, 8, 824);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 27, 6, 749);
			attr_dev(div, "class", "w-100 p-4 px-5 shadow-sm project rounded-lg  svelte-od01vd");
...
//# sourceMappingURL=other-tabs-584e0955.js.map
