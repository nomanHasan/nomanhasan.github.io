...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(h30, "class", "text-gray-600 font-light");
			add_location(h30, file$1, 21, 6, 541);
			attr_dev(h31, "class", "text-gray-700 ");
			add_location(h31, file$1, 22, 6, 608);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 24, 8, 724);
			attr_dev(h32, "class", "text-gray-500 font-light text-xs");
...
//# sourceMappingURL=other-tabs-c43ca9bf.js.map
