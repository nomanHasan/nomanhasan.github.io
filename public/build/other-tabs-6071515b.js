...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light text-gray-700 mt-2");
			add_location(div, file$1, 30, 8, 955);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(30:6) {#if proj.description}",
		ctx
	});
...
function create_each_block$1(key_1, ctx) {
	...
	let h31;
	let t4;
	let t5_value = /*proj*/ ctx[0].dev_tools + "";
	let t5;
	let t6;
	let h32;
	let a;
	let t7_value = /*proj*/ ctx[0].github_repo + "";
	let t7;
	let a_href_value;
	let t8;
	let div0;
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(h30, "class", "text-blue-400 font-light");
			add_location(h30, file$1, 21, 6, 541);
			attr_dev(h31, "class", "text-gray-700 ");
			add_location(h31, file$1, 22, 6, 608);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 24, 8, 716);
			attr_dev(h32, "class", "text-gray-500 font-light");
			add_location(h32, file$1, 23, 6, 670);
			attr_dev(div0, "class", "flex flex-row overflow-hidden");
			set_style(div0, "max-width", "100%");
			set_style(div0, "text-overflow", "ellipsis");
			set_style(div0, "white-space", "nowrap");
			add_location(div0, file$1, 26, 6, 784);
			attr_dev(div1, "class", "p-4 px-5 shadow-sm m-1 rounded-lg");
...
//# sourceMappingURL=other-tabs-6071515b.js.map
