...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 24, 6, 523);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 25, 6, 592);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 26, 6, 664);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 28, 8, 799);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 27, 6, 724);
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-4dfxgb");
			add_location(div, file$1, 23, 4, 461);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 projects w-full svelte-4dfxgb");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h20, file$2, 11, 2, 287);
			attr_dev(h21, "class", "font-hairline text-3xl uppercase text-center text-gray-800 my-3");
			attr_dev(h21, "id", "experience");
			add_location(h21, file$2, 17, 2, 424);
			attr_dev(h22, "class", "font-hairline text-3xl uppercase text-center text-gray-800 my-3");
			attr_dev(h22, "id", "skills");
			add_location(h22, file$2, 23, 2, 567);
			attr_dev(div, "class", "flex flex-col tabs lg:overflow-y-auto h-full w-full max-h-screen svelte-szsaly");
			add_location(div, file$2, 10, 0, 206);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-6d621c1d.js.map
