...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div14, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 skills w-full svelte-1oqoaym");
...
//# sourceMappingURL=other-tabs-9629985a.js.map
