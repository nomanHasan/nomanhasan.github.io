...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 rounded-lg");
			add_location(div, file$1, 19, 4, 423);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
//# sourceMappingURL=other-tabs-2d2d8677.js.map
