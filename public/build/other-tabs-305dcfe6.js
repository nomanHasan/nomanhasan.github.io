...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(div, "class", "pr-1 font-light text-gray-700 mt-2");
			add_location(div, file$1, 28, 8, 905);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(28:6) {#if proj.description}",
		ctx
	});
...
//# sourceMappingURL=other-tabs-305dcfe6.js.map
