...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 30, 12, 1016);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 28, 12, 941);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
// (27:8) {#each expr.development_tools as devt, i}
function create_each_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(27:8) {#each expr.development_tools as devt, i}",
		ctx
	});
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 35, 8, 1147);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(35:6) {#if expr.description}",
		ctx
	});
...
// (18:2) {#each experiences as expr (expr.name)}
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(div0, file, 23, 6, 724);
			attr_dev(div1, "class", "p-4 px-5 shadow-sm m-1 rounded-lg w-full");
			add_location(div1, file, 18, 4, 407);
			this.first = div1;
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(18:2) {#each experiences as expr (expr.name)}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 experience svelte-1ycgl14");
			add_location(div, file, 16, 0, 290);
		},
...
//# sourceMappingURL=other-tabs-02a4282a.js.map
