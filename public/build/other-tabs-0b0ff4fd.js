...
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(div1, file, 19, 4, 427);
			this.first = div1;
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 experience svelte-oz47om");
...
//# sourceMappingURL=other-tabs-0b0ff4fd.js.map
