...
// (22:2) {#each projects as proj (proj.title)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 23, 6, 504);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 24, 6, 573);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 25, 6, 645);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 27, 8, 780);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 26, 6, 705);
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-l9zbuq");
			add_location(div, file$1, 22, 4, 442);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(22:2) {#each projects as proj (proj.title)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 projects w-full svelte-l9zbuq");
			add_location(div, file$1, 20, 0, 322);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=other-tabs-c80fe8fa.js.map
