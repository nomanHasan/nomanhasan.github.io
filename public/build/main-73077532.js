...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 27, 4, 476);
			attr_dev(h1, "class", "text-4xl text-gray-800 name uppercase text-center my-4 svelte-15o8d4m");
			add_location(h1, file$1, 33, 4, 607);
			attr_dev(h20, "class", "text-lg text-gray-700 text-center n2 svelte-15o8d4m");
			add_location(h20, file$1, 36, 4, 707);
			attr_dev(h21, "class", "text-md text-gray-600 text-center n2 svelte-15o8d4m");
			add_location(h21, file$1, 37, 4, 783);
			add_location(b0, file$1, 39, 6, 908);
			attr_dev(h22, "class", "text-md text-gray-700 text-center n2 svelte-15o8d4m");
			add_location(h22, file$1, 38, 4, 852);
			attr_dev(div0, "class", "flex flex-col py-4");
			add_location(div0, file$1, 42, 4, 969);
			add_location(b1, file$1, 54, 8, 1409);
			attr_dev(a0, "class", "text-gray-800 text-center");
			attr_dev(a0, "href", "mailto:nomanbinhussein@gmail.com");
			add_location(a0, file$1, 51, 6, 1307);
			attr_dev(div1, "class", "flex flex-col mb-4");
			add_location(div1, file$1, 50, 4, 1268);
			add_location(b2, file$1, 59, 8, 1585);
			attr_dev(a1, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a1, "href", "#projects");
			add_location(a1, file$1, 58, 6, 1507);
			add_location(b3, file$1, 62, 8, 1698);
			attr_dev(a2, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a2, "href", "#experience");
			add_location(a2, file$1, 61, 6, 1618);
			add_location(b4, file$1, 65, 8, 1809);
			attr_dev(a3, "class", "text-gray-500 py-2 text-center underline");
			attr_dev(a3, "href", "#skills");
			add_location(a3, file$1, 64, 6, 1733);
			attr_dev(div2, "class", "flex flex-col mb-4");
			add_location(div2, file$1, 57, 4, 1468);
			attr_dev(div3, "class", "innerdiv flex flex-col justify-start");
			add_location(div3, file$1, 26, 2, 421);
			attr_dev(div4, "class", "profile flex flex-row justify-center svelte-15o8d4m");
			add_location(div4, file$1, 25, 0, 368);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-g0j1sk");
			add_location(div, file$2, 36, 0, 867);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-df001d4e.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-73077532.js.map
