...
function create_each_block_4(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			attr_dev(div, "class", "m-1 p-2 rounded-sm bg-gray-100");
...
//# sourceMappingURL=other-tabs-15bc3135.js.map
