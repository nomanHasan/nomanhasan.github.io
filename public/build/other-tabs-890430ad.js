...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 71, 10, 2141);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div15, file$2, 68, 6, 1997);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 69, 6, 2043);
			add_location(div17, file$2, 67, 4, 1985);
...
//# sourceMappingURL=other-tabs-890430ad.js.map
