...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 35, 12, 1160);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 33, 12, 1085);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 40, 8, 1291);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(div0, file, 28, 6, 868);
			attr_dev(div1, "class", "p-4 px-5 shadow-sm m-1 rounded-lg");
			add_location(div1, file, 23, 4, 558);
			this.first = div1;
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h2, file, 19, 2, 412);
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 experience svelte-a9owcz");
			add_location(div, file, 18, 0, 339);
		},
...
//# sourceMappingURL=experience-card-8a7a482f.js.map
