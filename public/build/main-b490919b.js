...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(h1, "class", "text-4xl text-gray-800 name uppercase text-center my-4 svelte-h23skn");
			add_location(h1, file$1, 33, 4, 607);
			attr_dev(h20, "class", "text-lg text-gray-700 text-center n2 svelte-h23skn");
			add_location(h20, file$1, 36, 4, 707);
			attr_dev(h21, "class", "text-md text-gray-600 text-center n2 svelte-h23skn");
			add_location(h21, file$1, 37, 4, 783);
			add_location(b0, file$1, 39, 6, 908);
			attr_dev(h22, "class", "text-md text-gray-700 text-center n2 svelte-h23skn");
			...
			attr_dev(div4, "class", "profile flex flex-row justify-center svelte-h23skn");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-16l1jsp");
			add_location(div, file$2, 36, 0, 866);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-05a5d872.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-b490919b.js.map
