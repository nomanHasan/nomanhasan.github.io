...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-wfp1s3");
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 projects w-full svelte-wfp1s3");
...
//# sourceMappingURL=other-tabs-2be6b64a.js.map
