...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(h2, file$1, 19, 6, 458);
			attr_dev(h30, "class", "py-1 text-gray-600 font-light");
			add_location(h30, file$1, 20, 6, 527);
			attr_dev(h31, "class", "py-1 text-gray-700 ");
			add_location(h31, file$1, 21, 6, 599);
			attr_dev(a, "href", a_href_value = /*proj*/ ctx[0].github_repo);
			add_location(a, file$1, 23, 8, 734);
			attr_dev(h32, "class", "py-1 text-gray-500 font-light text-sm hover:underline");
			add_location(h32, file$1, 22, 6, 659);
			attr_dev(div, "class", "p-4 px-5 shadow-sm m-1 project rounded-lg svelte-14vn8qd");
			add_location(div, file$1, 18, 4, 396);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "flex flex-col py-4 mt-6 text-lg text-gray-600 projects w-full svelte-14vn8qd");
...
//# sourceMappingURL=other-tabs-be9cd19f.js.map
