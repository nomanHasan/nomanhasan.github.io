...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 43, 10, 1240);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 54, 10, 1524);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			add_location(div, file$2, 62, 10, 1745);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div7, file$2, 40, 6, 1103);
			attr_dev(div8, "class", "flex flex-row");
			add_location(div8, file$2, 41, 6, 1146);
			add_location(div9, file$2, 39, 4, 1091);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 277);
			attr_dev(div11, "class", "text-2xl");
			add_location(div11, file$2, 49, 4, 1335);
			attr_dev(div12, "class", "text-xl");
			add_location(div12, file$2, 51, 6, 1388);
			attr_dev(div13, "class", "flex flex-row");
			add_location(div13, file$2, 52, 6, 1430);
			add_location(div14, file$2, 50, 4, 1376);
			attr_dev(div15, "class", "text-xl");
			add_location(div15, file$2, 59, 6, 1602);
			attr_dev(div16, "class", "flex flex-row");
			add_location(div16, file$2, 60, 6, 1648);
			add_location(div17, file$2, 58, 4, 1590);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 48, 2, 1313);
...
//# sourceMappingURL=other-tabs-4d45345a.js.map
