...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-1m26uzi");
			add_location(div, file$2, 28, 0, 662);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-e768b482.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-5a9ebf62.js.map
