...
function create_fragment$2(ctx) {
	...
	let div5;
	let t9;
	let each_value_2 = skills.proficient.languages;
	...
	let each_value_1 = skills.proficient.technologies;
	validate_each_argument(each_value_1);
	let each_blocks_1 = [];
	...
	let each_value = skills.proficient.databases;
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		c: function create() {
			...
			attr_dev(div8, "class", "flex flex-row py-4 mt-6 text-lg text-gray-600 skills w-full svelte-1oqoaym");
			add_location(div8, file$2, 12, 0, 201);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*skills*/ 0) {
				each_value_2 = skills.proficient.languages;
				validate_each_argument(each_value_2);
				let i;
			...
			if (dirty & /*skills*/ 0) {
				each_value_1 = skills.proficient.technologies;
				validate_each_argument(each_value_1);
				let i;
			...
			if (dirty & /*skills*/ 0) {
				each_value = skills.proficient.databases;
				validate_each_argument(each_value);
				let i;
...
//# sourceMappingURL=other-tabs-f5402671.js.map
