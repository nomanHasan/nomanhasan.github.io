...
function instance$6($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-dc902558.js').then(module => module.default).then(component => {
...
function create_fragment$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			if (if_block) if_block.c();
			add_location(h2, file$4, 40, 2, 928);
			attr_dev(div, "class", "resume flex flex-col justify-start py-2 svelte-gwihkv");
			add_location(div, file$4, 39, 0, 872);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-81e8500c.js.map
