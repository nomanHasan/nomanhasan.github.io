...
function create_each_block_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 19, 10, 536);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 31, 10, 949);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(div, "color", "hsl(0, 0%, " + /*i*/ ctx[2] * 7 + "%)");
			set_style(div, "font-weight", 900 - /*i*/ ctx[2] * 70);
			add_location(div, file$2, 43, 10, 1356);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 58, 10, 1854);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 71, 10, 2353);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$2, 14, 4, 297);
			attr_dev(div1, "class", " py-2");
			add_location(div1, file$2, 16, 6, 389);
			attr_dev(div2, "class", "flex flex-row flex-wrap");
			add_location(div2, file$2, 17, 6, 429);
			attr_dev(div3, "class", "py-4");
			add_location(div3, file$2, 15, 4, 364);
			attr_dev(div4, "class", "py-2");
			add_location(div4, file$2, 28, 6, 796);
			attr_dev(div5, "class", "flex flex-row flex-wrap");
			add_location(div5, file$2, 29, 6, 839);
			attr_dev(div6, "class", "py-4");
			add_location(div6, file$2, 27, 4, 771);
			attr_dev(div7, "class", " py-2");
			add_location(div7, file$2, 40, 6, 1208);
			attr_dev(div8, "class", "flex flex-row flex-wrap");
			add_location(div8, file$2, 41, 6, 1249);
			attr_dev(div9, "class", "py-4");
			add_location(div9, file$2, 39, 4, 1183);
			attr_dev(div10, "class", "p-4");
			add_location(div10, file$2, 13, 2, 275);
			attr_dev(div11, "class", "text-2xl text-gray-700 font-bold");
			add_location(div11, file$2, 53, 4, 1619);
			attr_dev(div12, "class", " py-2");
			add_location(div12, file$2, 55, 6, 1709);
			attr_dev(div13, "class", "flex flex-row flex-wrap");
			add_location(div13, file$2, 56, 6, 1749);
			attr_dev(div14, "class", "py-4");
			add_location(div14, file$2, 54, 4, 1684);
			attr_dev(div15, "class", " py-2");
			add_location(div15, file$2, 68, 6, 2201);
			attr_dev(div16, "class", "flex flex-row flex-wrap");
			add_location(div16, file$2, 69, 6, 2245);
			attr_dev(div17, "class", "py-4");
			add_location(div17, file$2, 67, 4, 2176);
			attr_dev(div18, "class", "p-4");
			add_location(div18, file$2, 52, 2, 1597);
...
//# sourceMappingURL=other-tabs-354098d4.js.map
