...
function instance$7($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-38d75cb8.js').then(module => module.default).then(component => {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$4, 46, 2, 947);
			attr_dev(div1, "class", "resume-container bg-gray-200 svelte-1gr0j8o");
			add_location(div1, file$4, 45, 0, 902);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-92d0af26.js.map
