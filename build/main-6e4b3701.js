...
function instance$7($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-3e6a8cfd.js').then(module => module.default).then(component => {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			div0 = element("div");
			if (if_block) if_block.c();
			attr_dev(div0, "class", "resume bg-white flex flex-col justify-start py-2 mx-auto svelte-jdaw12");
			add_location(div0, file$4, 42, 2, 916);
			attr_dev(div1, "class", "resume-container bg-gray-200 svelte-jdaw12");
			add_location(div1, file$4, 41, 0, 871);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-6e4b3701.js.map
