...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-2bijbu");
			add_location(div, file$2, 41, 0, 901);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-1e01ddee.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-fd6284ea.js.map
