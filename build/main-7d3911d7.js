...
function instance$7($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-7ff4a51b.js').then(module => module.default).then(component => {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			div0 = element("div");
			if (if_block) if_block.c();
			attr_dev(div0, "class", "resume flex flex-col justify-start py-2 svelte-1hg4p6a");
...
//# sourceMappingURL=main-7d3911d7.js.map
