...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 45, 2, 975);
			attr_dev(span, "class", "text-center px-4");
			add_location(span, file$1, 46, 2, 1041);
			...
			add_location(button, file$1, 42, 0, 855);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$6($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-98ab16c0.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-b6220d5b.js.map
