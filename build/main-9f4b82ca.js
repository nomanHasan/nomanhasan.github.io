...
function create_fragment$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			if (if_block) if_block.c();
			attr_dev(div, "class", "app flex flex-col justify-start py-2");
			add_location(div, file$3, 17, 0, 433);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$6($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-fc3255d5.js').then(module => module.default).then(component => {
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$4, 8, 2, 159);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function instance$7($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Router, Link, Route, Home, url });
...
//# sourceMappingURL=main-9f4b82ca.js.map
