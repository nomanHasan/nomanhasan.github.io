...
function instance$7($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-72622a90.js').then(module => module.default).then(component => {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			div0 = element("div");
			if (if_block) if_block.c();
			attr_dev(div0, "class", "resume bg-white flex flex-col justify-start py-2 mx-auto svelte-nw5lct");
			add_location(div0, file$4, 47, 2, 977);
			attr_dev(div1, "class", "resume-container bg-gray-200 svelte-nw5lct");
...
//# sourceMappingURL=main-aa3c0266.js.map
