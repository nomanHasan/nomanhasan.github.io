...
function create_fragment$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			if (if_block) if_block.c();
			attr_dev(div, "class", "app flex flex-col justify-start py-2 svelte-ohcinb");
			add_location(div, file$3, 39, 0, 893);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$6($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-0dfaa282.js').then(module => module.default).then(component => {
...
//# sourceMappingURL=main-2f1c1f95.js.map
