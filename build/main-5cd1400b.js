...
class Button extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { text: 0, icon: 1, classes: 2 });
...
function instance$6($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-ab14a746.js').then(module => module.default).then(component => {
...
function create_fragment$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			if (if_block) if_block.c();
			add_location(h2, file$4, 39, 2, 902);
			attr_dev(div, "class", "resume flex flex-col justify-start py-2 svelte-prn5rt");
			add_location(div, file$4, 38, 0, 846);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$5, 9, 2, 193);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function instance$8($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Router, Link, Route, Home, Resume, url });
...
//# sourceMappingURL=main-5cd1400b.js.map
