...
function instance$7($$self, $$props, $$invalidate) {
	...
	import('./other-tabs-f29830aa.js').then(module => module.default).then(component => {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			div0 = element("div");
			if (if_block) if_block.c();
			attr_dev(div0, "class", "resume bg-white flex flex-col justify-start py-2 mx-auto svelte-hplwj3");
			add_location(div0, file$4, 42, 2, 915);
			attr_dev(div1, "class", "resume-container bg-gray-200 svelte-hplwj3");
...
//# sourceMappingURL=main-9cac0109.js.map
